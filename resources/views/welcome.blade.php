                  ...
                  <div class="carousel-inner col-lg-12 col-md-4 col-sm-12" style="margin-top: 50px;">
                    <div class="carousel-item active">
                      <div class="row justify-content-evenly">
                                        ...
                                        <div class="card" style="width: 23rem; border-radius: 20px; background-color: #FEE3E0;">
                                          <img src="{{asset('images/toyotaPajero.jpg')}}" class="card-img img-fluid p-3 mt-2 h-100" alt="...">
                                          <div class="card-body">
                                            <h4 class="card-title">Toyota Pajero</h4>
                                            <p class="text-end">Plat Genap</p>
                                            <h5>Harga</h5>
                                            <h4>Rp. 6.000.000/1 Hari</h4>
                                          </div>
                                        ...
                                        <div class="card" style="width: 23rem; border-radius: 20px; background-color: #5C5656;">
                                          <img src="{{asset('images/hondaJazz.jpg')}}" class="card-img img-fluid p-3 mt-2 h-100" alt="...">
                                        ...
                                        <div class="card" style="width: 23rem; border-radius: 20px; background-color: #FEE3E0;">
                                          <img src="{{asset('images/hondaHrvMerah.jpg')}}" class="card-img img-fluid p-3 mt-2 h-100" alt="...">
                                          <div class="card-body">
                                            <h4 class="card-title">Honda HRV Merah</h4>
                                            <p class="text-end">Plat Genap</p>
                                            <h5>Harga</h5>
                    ...
                    <div class="carousel-item">
                      <div class="row justify-content-evenly">
                                        ...
                                        <div class="card" style="width: 23rem; border-radius: 20px; background-color: #5C5656;">
                                          <img src="{{asset('images/hondaHrv.jpg')}}" class="card-img img-fluid p-3 mt-2 h-100" alt="...">
                                          <div class="card-body" style="color: white;">
                                            <h4 class="card-title">Honda HRV</h4>
                                            <p class="text-end">Plat Genap</p>
                                            <h5>Harga</h5>
                                            <h4>Rp. 400.000/1 Hari</h4>
                                          </div>
                                          <div class="card-body text-center mb-4" style="">
                                            <button onclick="welcome(event)" class="btn fs-5" role="button" data-bs-toggle="button" style="border-radius:10px; background-color: #FEE3E0; color: #5C5656;">Chat melalui WhatsApp</button>
                                          </div>
                                        ...
                                        <div class="card" style="width: 23rem; border-radius: 20px; background-color: #FEE3E0;">
                                          <img src="{{asset('images/hondaFit.jpg')}}" class="card-img img-fluid p-3 mt-2 h-100" alt="...">
                                          <div class="card-body" style="color: black;">
                                            <h4 class="card-title">Honda Fit</h4>
                                            <p class="text-end">Plat Genap</p>
                                            <h5>Harga</h5>
                                            <h4>Rp. 200.000/1 Hari</h4>
                                          </div>
                                          <div class="card-body text-center mb-4" style="">
                                            <button onclick="welcome(event)" class="btn fs-5" role="button" data-bs-toggle="button" style="border-radius:10px; background-color:#A80743; color:white;">Chat melalui WhatsApp</button>
                                          </div>
                                        ...
                                        <div class="card" style="width: 23rem; border-radius: 20px; background-color: #5C5656;">
                                          <img src="{{asset('images/hondaCivic.jpg')}}" class="card-img img-fluid p-3 mt-2 h-100" alt="...">
                                          <div class="card-body" style="color: white;">
                    ...
                    <div class="carousel-item">
                      <div class="row justify-content-evenly">
                                        ...
                                        <div class="card" style="width: 23rem; border-radius: 20px; background-color: #FEE3E0;">
                                          <img src="{{asset('images/bmwM3.jpg')}}" class="card-img img-fluid p-3 mt-2 h-100" alt="...">
                                          <div class="card-body">
                                            <h4 class="card-title">BMW M3</h4>
                                            <p class="text-end">Plat Genap</p>
                                            <h5>Harga</h5>
                                            <h4>Rp. 1.000.000/1 Hari</h4>
                                          </div>
                                          <div class="card-body text-center mb-4" style="">
                                            <button onclick="welcome(event)" class="btn fs-5" role="button" data-bs-toggle="button" style="border-radius:10px; background-color:#A80743; color:white;">Chat melalui WhatsApp</button>
                                          </div>
                                        ...
                                        <div class="card" style="width: 23rem; border-radius: 20px; background-color: #5C5656;">
                                          <img src="{{asset('images/bmwM3Putih.jpg')}}" class="card-img img-fluid p-3 mt-2 h-100" alt="...">
                                          <div class="card-body" style="color: white;">
                                            <h4 class="card-title">BMW M3 Putih</h4>
                                            <p class="text-end">Plat Genap</p>
                                            <h5>Harga</h5>
                                            <h4>Rp. 1.000.000/1 Hari</h4>
                                          </div>
                                        ...
                                        <div class="card" style="width: 23rem; border-radius: 20px; background-color: #FEE3E0;">
                                          <img src="{{asset('images/toyotaYaris.jpg')}}" class="card-img img-fluid p-3 mt-2 h-100" alt="...">
                                          <div class="card-body">
                    ...
                    <div class="carousel-item">
                      <div class="row justify-content-evenly">
                                         {{-- carousel dua card satu --}}
                                        <div class="card" style="width: 23rem; border-radius: 20px; background-color: #5C5656;">
                                          <img src="{{asset('images/toyotaYarisMerah.jpg')}}" class="card-img img-fluid p-3 mt-2 h-100" alt="...">
                                          <div class="card-body" style="color: white;">
                                            <h4 class="card-title">Toyota Yaris Merah</h4>
                                            <p class="text-end">Plat Genap</p>
                                            <h5>Harga</h5>
                                        ...
                                        {{-- carousel dua card dua --}}
                                        <div class="card" style="width: 23rem; border-radius: 20px; background-color: #FEE3E0;">
                                          <img src="{{asset('images/toyotaFortunerPutih.jpg')}}" class="card-img img-fluid p-3 mt-2 h-100" alt="...">
                                          <div class="card-body" style="color: black;">
                                            <h4 class="card-title">Toyota Fortuner Putih</h4>
                                            <p class="text-end">Plat Genap</p>
                                            <h5>Harga</h5>
                                            <h4>Rp. 700.000/1 Hari</h4>
                                          </div>
                                        ...
                                        {{-- carousel dua card tiga --}}
                                        <div class="card" style="width: 23rem; border-radius: 20px; background-color: #5C5656;">
                                          <img src="{{asset('images/toyotaFortunerMerah.jpg')}}" class="card-img img-fluid p-3 mt-2 h-100" alt="...">
                                          <div class="card-body" style="color: white;">
                                            <h4 class="card-title">Toyota Fortuner Merah</h4>
                                            <p class="text-end">Plat Genap</p>
                                            <h5>Harga</h5>
                                            <h4>Rp. 750.000/1 Hari</h4>
                                          </div>
                                          <div class="card-body text-center mb-4" style="">
                                            <button onclick="welcome(event)" class="btn fs-5" role="button" data-bs-toggle="button" style="border-radius:10px; background-color: #FEE3E0; color: #5C5656;">Chat melalui WhatsApp</button>
                                          </div>
